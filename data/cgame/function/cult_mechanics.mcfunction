...
execute as @a[team=cgame_cultist,scores={cgame_on=1}] at @s if entity @a[team=cgame_cultist,scores={cgame_on=1},distance=1..10] run effect give @s resistance 1 255 false
...
execute as @a[team=cgame_cultist,scores={cgame_on=1}] if score #number_of_cultists cgame_variable matches 1 run effect give @s resistance 2 255 false
