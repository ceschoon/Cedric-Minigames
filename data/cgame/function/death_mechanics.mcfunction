...
execute if entity @a[team=cgame_increment,scores={cgame_on=1,ctime_DeathCount=1..}] unless entity @a[team=cgame_regular,scores={cgame_on=1,cgame_kill_detect=1..}] run scoreboard players operation #minscore cgame_score = @r[team=cgame_regular,scores={cgame_on=1}] cgame_score
execute if entity @a[team=cgame_increment,scores={cgame_on=1,ctime_DeathCount=1..}] unless entity @a[team=cgame_regular,scores={cgame_on=1,cgame_kill_detect=1..}] as @a[team=cgame_regular,scores={cgame_on=1}] run scoreboard players operation #minscore cgame_score < @s cgame_score
execute if entity @a[team=cgame_increment,scores={cgame_on=1,ctime_DeathCount=1..}] unless entity @a[team=cgame_regular,scores={cgame_on=1,cgame_kill_detect=1..}] as @a[team=cgame_regular,scores={cgame_on=1}] if score @s cgame_score = #minscore cgame_score run team join cgame_increment @s
...
execute if entity @a[team=cgame_increment,scores={cgame_on=1,ctime_DeathCount=1..}] run team join cgame_increment @a[team=cgame_regular,scores={cgame_on=1,cgame_kill_detect=1..}]

# If the solo ("tagged") player dies, he becomes a regular player again
team join cgame_regular @a[team=cgame_increment,scores={cgame_on=1,ctime_DeathCount=1..},limit=1]
