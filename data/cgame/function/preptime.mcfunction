...
execute if score #ctime_TicksInSec ctime_variable matches 0 if score #cgame_preptime cgame_setting matches 0 run tellraw @a[scores={cgame_on=1}] [{"text":"The score will now increase for the tagged player!","color":"gold"}]
