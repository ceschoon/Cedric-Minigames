...
tellraw @a [" "]
tellraw @a [{"text":"Step 1: Select a game preset","color":"gold"}]
...
tellraw @a [" "]
tellraw @a [{"text":"Step 2: Tweak the settings (Optional)","color":"gold"}]
...
tellraw @a [" "]
tellraw @a [{"text":"Step 3: Start the game","color":"gold"}]
