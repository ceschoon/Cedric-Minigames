...
execute if score #shrine_active inf_variable matches 0 if score #ctime_TicksInSec ctime_variable matches 15 run summon area_effect_cloud ~ ~ ~ {Particle:{type:flame},potion_contents:{custom_effects:[{id:instant_damage,duration:10,show_particles:1b,show_icon:1}]},Radius:2.5,RadiusPerTick:-0.0,Duration:10}
