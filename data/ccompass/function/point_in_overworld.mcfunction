...
execute at @s run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:compass",count:1,components:{lore:['{"text":"Dimension: Overworld","italic":false}','{"text":"Put me in a crafting table to change the target","italic":false}']}}}
