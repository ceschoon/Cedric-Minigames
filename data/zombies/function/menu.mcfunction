...
tellraw @a [{"text":"[Reload]","color":"dark_aqua", "clickEvent":{"action":"run_command","value":"/function zombies:load"}}]
...
tellraw @a [{"text":"[Join Team Zombies]","color":"aqua", "clickEvent":{"action":"run_command","value":"/function zombies:jointeamzombies"}}]
