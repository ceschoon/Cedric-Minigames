# Permanent effects
effect give @a[scores={flsheep_On=1}] saturation 10

# Rng
scoreboard players set @a[scores={flsheep_On=1,flsheep_rng=100..}] flsheep_rng 0

# Kill players who fell off the map
kill @a[x=-1000000,y=0,z=-1000000,dx=2000000,dy=149,dz=2000000,scores={flsheep_On=1,flsheep_DeathCnt=0}]

# Delay respawn
execute if score #ctime_Pause ctime_variable matches 0 run scoreboard players set @a[scores={flsheep_On=1,flsheep_DeathCnt=201..}] flsheep_DeathCnt 0
execute if score #ctime_Pause ctime_variable matches 0 run scoreboard players add @a[scores={flsheep_On=1,flsheep_DeathCnt=1..}] flsheep_DeathCnt 1

# Handle dead players
gamemode spectator @a[scores={flsheep_On=1,flsheep_DeathCnt=2}]
execute at @e[type=armor_stand,name=centre] run tp @a[scores={flsheep_On=1,flsheep_DeathCnt=1..199}] ~ ~20 ~
title @a[scores={flsheep_On=1,flsheep_DeathCnt=2}] title [{"text":"You died!","color":"red"}]
title @a[scores={flsheep_On=1,flsheep_DeathCnt=2}] subtitle [{"text":"You will respawn in 10 seconds...","color":"red"}]
gamemode survival @a[scores={flsheep_On=1,flsheep_DeathCnt=200}]

# Tp players who respawned back to team platform
execute at @e[type=armor_stand,name=team1] run tp @a[scores={flsheep_On=1,flsheep_DeathCnt=200},team=team1] ~ ~ ~
execute at @e[type=armor_stand,name=team2] run tp @a[scores={flsheep_On=1,flsheep_DeathCnt=200},team=team2] ~ ~ ~
execute at @e[type=armor_stand,name=team3] run tp @a[scores={flsheep_On=1,flsheep_DeathCnt=200},team=team3] ~ ~ ~
execute at @e[type=armor_stand,name=team4] run tp @a[scores={flsheep_On=1,flsheep_DeathCnt=200},team=team4] ~ ~ ~

# Force players to wear team colors + elytra
execute as @a[scores={flsheep_On=1}] if entity @s[team=team1] unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet"}]}] run item replace entity @s armor.head with leather_helmet[dyed_color={rgb:65280},enchantments={levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}]
execute as @a[scores={flsheep_On=1}] if entity @s[team=team2] unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet"}]}] run item replace entity @s armor.head with leather_helmet[dyed_color={rgb:16711680},enchantments={levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}]
execute as @a[scores={flsheep_On=1}] if entity @s[team=team3] unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet"}]}] run item replace entity @s armor.head with leather_helmet[dyed_color={rgb:255},enchantments={levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}]
execute as @a[scores={flsheep_On=1}] if entity @s[team=team4] unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet"}]}] run item replace entity @s armor.head with leather_helmet[dyed_color={rgb:16776960},enchantments={levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}]
execute as @a[scores={flsheep_On=1}] unless entity @s[nbt={Inventory:[{Slot:102b,id:"minecraft:elytra"}]}] run item replace entity @s armor.chest with elytra
...
# Reset platforms
execute if score #flsheep_NumTeams flsheep_variable matches 2 at @e[type=armor_stand,name=centre] run function flsheep:buildcentre2
execute if score #flsheep_NumTeams flsheep_variable matches 4 at @e[type=armor_stand,name=centre] run function flsheep:buildcentre4
...
execute if score #ctime_Pause ctime_variable matches 0 run scoreboard players remove #flsheep_Delay flsheep_variable 1
...
execute at @e[type=armor_stand,name=centre] if score #flsheep_Delay flsheep_variable matches ..0 if entity @p[scores={flsheep_On=1,flsheep_rng=0..79}] run summon sheep ~ ~2 ~ {Color:0}
execute at @e[type=armor_stand,name=centre] if score #flsheep_Delay flsheep_variable matches ..0 if entity @p[scores={flsheep_On=1,flsheep_rng=70..79}] run summon sheep ~ ~2 ~ {Color:0}
execute at @e[type=armor_stand,name=centre] if score #flsheep_Delay flsheep_variable matches ..0 if entity @p[scores={flsheep_On=1,flsheep_rng=80..89}] run summon sheep ~ ~2 ~ {Color:6}
execute at @e[type=armor_stand,name=centre] if score #flsheep_Delay flsheep_variable matches ..0 if entity @p[scores={flsheep_On=1,flsheep_rng=90..99}] run summon wolf ~ ~2 ~

# Reset delay for sheep spawning
execute if score #flsheep_Delay flsheep_variable matches ..0 if score #flsheep_NumTeams flsheep_variable matches 2 run scoreboard players set #flsheep_Delay flsheep_variable 300
