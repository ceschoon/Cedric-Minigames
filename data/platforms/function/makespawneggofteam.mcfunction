...
execute store result score @s pltf_temp run clear @s vex_spawn_egg[lore=['{"text":"Will not be hostile to you","italic":false}']] 1
execute if entity @s[scores={pltf_temp=1},team=team1] run give @s vex_spawn_egg[entity_data={id:vex,Team:team1,PersistenceRequired:1},lore=['{"text":"Member of the green team","italic":false,"color":green}']]
execute if entity @s[scores={pltf_temp=1},team=team2] run give @s vex_spawn_egg[entity_data={id:vex,Team:team2,PersistenceRequired:1},lore=['{"text":"Member of the red team","italic":false,"color":red}']]
execute if entity @s[scores={pltf_temp=1},team=team3] run give @s vex_spawn_egg[entity_data={id:vex,Team:team3,PersistenceRequired:1},lore=['{"text":"Member of the blue team","italic":false,"color":blue}']]
execute if entity @s[scores={pltf_temp=1},team=team4] run give @s vex_spawn_egg[entity_data={id:vex,Team:team4,PersistenceRequired:1},lore=['{"text":"Member of the yellow team","italic":false,"color":yellow}']]
