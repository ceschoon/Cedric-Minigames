...
tellraw @a [{"text":"[Randomize settings]","color":"aqua", "clickEvent":{"action":"run_command","value":"/function platforms:randomize_settings"}}]
tellraw @a [{"text":"[Change score to win]","color":"aqua", "clickEvent":{"action":"suggest_command","value":"/scoreboard players set #pltf_score_to_win pltf_setting 20"}}]
tellraw @a [{"text":"[Change delay for diamonds]","color":"aqua", "clickEvent":{"action":"suggest_command","value":"/scoreboard players set #pltf_delay_diamond pltf_setting 600"}}]
tellraw @a [{"text":"[Change delay for emeralds]","color":"aqua", "clickEvent":{"action":"suggest_command","value":"/scoreboard players set #pltf_delay_emerald pltf_setting 100"}}]
tellraw @a [{"text":"[Change delay for wool]","color":"aqua", "clickEvent":{"action":"suggest_command","value":"/scoreboard players set #pltf_delay_wool pltf_setting 30"}}]
