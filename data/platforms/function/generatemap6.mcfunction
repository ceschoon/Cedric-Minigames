scoreboard players set #pltf_NumTeams pltf_setting 2
...
execute at @s run summon armor_stand ~20 203 ~25 {Invisible:1b,Marker:1b,CustomName:"\"emerald1\"",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~-20 203 ~25 {Invisible:1b,Marker:1b,CustomName:"\"villager1\"",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~ 206 ~45 {Invisible:1b,Marker:1b,CustomName:"\"cannon1\"",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~ 206 ~-45 {Invisible:1b,Marker:1b,CustomName:"\"cannon2\"",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=cannon2] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team1 platform
execute at @s run summon armor_stand ~ 202 ~30 {Invisible:1b,Marker:1b,CustomName:"\"team1\"",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=team1] run function platforms:buildteam1
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team2 platform
execute at @s run summon armor_stand ~ 202 ~-30 {Invisible:1b,Marker:1b,CustomName:"\"team2\"",CustomNameVisible:0b}
