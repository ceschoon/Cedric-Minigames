...
execute at @e[type=armor_stand,name=team1] as @a[scores={pltf_On=1},team=team1,nbt={Inventory:[{id:"minecraft:golden_boots",components:{"minecraft:lore":['{"italic":false,"text":"Safety Boots"}']},count:1,Slot:100b}]},x=-1000000,y=149,z=-1000000,dx=2000000,dy=40,dz=2000000] run tp @s ~ ~ ~
execute at @e[type=armor_stand,name=team2] as @a[scores={pltf_On=1},team=team2,nbt={Inventory:[{id:"minecraft:golden_boots",components:{"minecraft:lore":['{"italic":false,"text":"Safety Boots"}']},count:1,Slot:100b}]},x=-1000000,y=149,z=-1000000,dx=2000000,dy=40,dz=2000000] run tp @s ~ ~ ~
execute at @e[type=armor_stand,name=team3] as @a[scores={pltf_On=1},team=team3,nbt={Inventory:[{id:"minecraft:golden_boots",components:{"minecraft:lore":['{"italic":false,"text":"Safety Boots"}']},count:1,Slot:100b}]},x=-1000000,y=149,z=-1000000,dx=2000000,dy=40,dz=2000000] run tp @s ~ ~ ~
execute at @e[type=armor_stand,name=team4] as @a[scores={pltf_On=1},team=team4,nbt={Inventory:[{id:"minecraft:golden_boots",components:{"minecraft:lore":['{"italic":false,"text":"Safety Boots"}']},count:1,Slot:100b}]},x=-1000000,y=149,z=-1000000,dx=2000000,dy=40,dz=2000000] run tp @s ~ ~ ~

# Kill players who fell off the map
kill @a[x=-1000000,y=0,z=-1000000,dx=2000000,dy=149,dz=2000000,scores={pltf_On=1,pltf_DeathCount=0}]
...
execute as @a[scores={pltf_On=1}] unless entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] if entity @s[team=team2] unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet"}]}] run item replace entity @s armor.head with leather_helmet[dyed_color={rgb:16711680},enchantments={levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}]
execute as @a[scores={pltf_On=1}] unless entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] if entity @s[team=team3] unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet"}]}] run item replace entity @s armor.head with leather_helmet[dyed_color={rgb:255},enchantments={levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}]
execute as @a[scores={pltf_On=1}] unless entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] if entity @s[team=team4] unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet"}]}] run item replace entity @s armor.head with leather_helmet[dyed_color={rgb:16776960},enchantments={levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}]
...
execute as @a[scores={pltf_On=1}] at @s unless entity @s[nbt={SelectedItem:{id:"minecraft:snowball"}}] if entity @e[type=snowball,distance=..3] run summon silverfish ~ ~ ~
execute as @a[scores={pltf_On=1}] at @s unless entity @s[nbt={SelectedItem:{id:"minecraft:snowball"}}] if entity @e[type=snowball,distance=..3] run summon silverfish ~ ~ ~
execute as @a[scores={pltf_On=1}] at @s unless entity @s[nbt={SelectedItem:{id:"minecraft:snowball"}}] if entity @e[type=snowball,distance=..3] run kill @e[type=snowball,distance=..3]
