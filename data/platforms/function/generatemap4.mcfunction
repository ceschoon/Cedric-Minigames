scoreboard players set #pltf_NumTeams pltf_setting 3
...
execute at @s run summon armor_stand ~-30 202 ~-15 {Invisible:1b,Marker:1b,CustomName:"emerald1",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~60 205 ~30 {Invisible:1b,Marker:1b,CustomName:"emerald2",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=emerald2] run function platforms:buildemerald
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build villager platform 1
execute at @s run summon armor_stand ~30 202 ~-15 {Invisible:1b,Marker:1b,CustomName:"villager1",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~-60 205 ~30 {Invisible:1b,Marker:1b,CustomName:"villager2",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~ 202 ~35 {Invisible:1b,Marker:1b,CustomName:"cannon1",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=cannon1] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build cannon platform 2
execute at @s run summon armor_stand ~ 205 ~-70 {Invisible:1b,Marker:1b,CustomName:"cannon2",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=cannon2] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team1 platform
execute at @s run summon armor_stand ~ 202 ~-35 {Invisible:1b,Marker:1b,CustomName:"team1",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=team1] run function platforms:buildteam1
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team2 platform
execute at @s run summon armor_stand ~-30 202 ~15 {Invisible:1b,Marker:1b,CustomName:"team2",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=team2] run function platforms:buildteam2
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team3 platform
execute at @s run summon armor_stand ~30 202 ~15 {Invisible:1b,Marker:1b,CustomName:"team3",CustomNameVisible:0b}
