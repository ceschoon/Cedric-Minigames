...
execute at @s run summon armor_stand ~15 200 ~15 {Invisible:1,Marker:1,CustomName:"\"emerald1\"",CustomNameVisible:0}
...
execute at @s run summon armor_stand ~15 200 ~-15 {Invisible:1,Marker:1,CustomName:"\"emerald2\"",CustomNameVisible:0}
execute at @e[type=armor_stand,name=emerald2] run function platforms:buildemerald
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build villager platform 1
execute at @s run summon armor_stand ~30 200 ~ {Invisible:1,Marker:1,CustomName:"\"villager1\"",CustomNameVisible:0}
...
execute at @s run summon armor_stand ~-30 205 ~15 {Invisible:1,Marker:1,CustomName:"\"cannon1\"",CustomNameVisible:0}
...
execute at @s run summon armor_stand ~-30 202 ~ {Invisible:1,Marker:1,CustomName:"\"team1\"",CustomNameVisible:0}
