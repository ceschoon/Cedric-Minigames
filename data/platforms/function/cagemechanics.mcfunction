...
execute unless entity @a[scores={pltf_DelayCage=1..}] at @e[type=armor_stand,name=diamond] run fill ~-3 ~-1 ~-3 ~3 ~3 ~3 air replace iron_trapdoor
execute unless entity @a[scores={pltf_DelayCage=1..}] at @e[type=armor_stand,name=diamond] run fill ~-3 ~-1 ~-3 ~3 ~3 ~3 air replace iron_bars
