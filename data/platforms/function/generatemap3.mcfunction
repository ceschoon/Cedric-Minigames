...
execute at @s run summon armor_stand ~-30 202 ~-15 {Invisible:1b,Marker:1b,CustomName:"\"cannon1\"",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~ 202 ~35 {Invisible:1b,Marker:1b,CustomName:"\"emerald1\"",CustomNameVisible:0b}
