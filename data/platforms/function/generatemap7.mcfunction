...
execute at @s run summon armor_stand ~10 199 ~-10 {Invisible:1b,Marker:1b,CustomName:"\"emerald1\"",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~-10 199 ~-10 {Invisible:1b,Marker:1b,CustomName:"\"emerald2\"",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=emerald2] run function platforms:buildemerald
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build villager platform 1
execute at @s run summon armor_stand ~ 199 ~15 {Invisible:1b,Marker:1b,CustomName:"\"villager1\"",CustomNameVisible:0b}
...
execute at @s run summon armor_stand ~ 205 ~35 {Invisible:1b,Marker:1b,CustomName:"\"cannon1\"",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=cannon1] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build cannon platform 2
execute at @s run summon armor_stand ~30 205 ~-15 {Invisible:1b,Marker:1b,CustomName:"\"cannon2\"",CustomNameVisible:0b}
execute at @e[type=armor_stand,name=cannon2] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build cannon platform 3
execute at @s run summon armor_stand ~-30 205 ~-15 {Invisible:1b,Marker:1b,CustomName:"\"cannon3\"",CustomNameVisible:0b}
