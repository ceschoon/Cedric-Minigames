...
execute if entity @a[scores={cworld_bordersize=20001..}] run tellraw @a [{"text":"WARNING: Worldborder too large, has been resized to 20000. \nThis is a feature of the Cedric-Minigames datapack.","color":"red","bold":false}]
execute if entity @a[scores={cworld_bordersize=20001..}] run worldborder set 20000
