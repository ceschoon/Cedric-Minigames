...
execute if score #cworld_bordersize cworld_variable matches 10001.. run tellraw @a [{"text":"WARNING: Worldborder too large, has been resized to 10000. \nThis is a feature of the Cedric-Minigames datapack.","color":"red","bold":false}]
execute if score #cworld_bordersize cworld_variable matches 10001.. run worldborder set 10000
