...
execute at @s run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:compass",Count:1b,tag:{display:{Lore:["\"Dimension: The End\""]}}}}

execute at @s run data merge entity @e[type=item,nbt={Item:{id:"minecraft:compass"}},distance=..3,limit=1] {Item:{tag:{LodestoneDimension:"minecraft:the_end", LodestoneTracked:0b}}}
