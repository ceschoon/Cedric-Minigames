...
execute at @s run data merge entity @e[type=item,nbt={Item:{id:"minecraft:compass"}},distance=..3,limit=1] {Item:{tag:{LodestoneDimension:"minecraft:the_nether", LodestoneTracked:0b}}}
