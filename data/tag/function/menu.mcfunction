...
tellraw @a [{"text":"[Change preparation time]","color":"aqua", "clickEvent":{"action":"suggest_command","value":"/scoreboard players set #tag_PrepTime tag_setting 0"}}]
...
tellraw @a [{"text":"[Change time to win (after start)]","color":"aqua", "clickEvent":{"action":"suggest_command","value":"/scoreboard players set #tag_TimeToWin tag_setting 1200"}}]
