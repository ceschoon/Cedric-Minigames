...
execute as @a[scores={animals_play_time=1}] at @e[tag=custom_animal] unless entity @a[distance=..128] run tp @e[tag=custom_animal,distance=..4] ~ -100 ~
kill @e[tag=custom_animal,x=-1000000,y=-200,z=-1000000,dx=2000000,dy=100,dz=2000000]
